...
Feature: Amazon Login
  ...
  Scenario: User should no be directed to  password field when invalic email is given
  Given I am on the login page
  When I enter invalid emial "jon.dow@gmail.com" 
  And I click the continue button 
  Then I should get error message says "We cannot find an account with that email address"
  And I should still be in the log in page
